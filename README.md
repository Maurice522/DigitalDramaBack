...
- `CARTESIA_LIVE_API_KEY`, `CARTESIA_API_KEY`, `CARTESIA_API_KEY_2`, `CARTESIA_API_KEY_3`, `CARTESIA_API_KEY_4`, `CARTESIA_BACKUP_API_KEY`, `CARTESIA_BACKUP_API_KEY_2`, `CARTESIA_BACKUP_API_KEY_3` — tried in that order; only a quota error falls through to the next key.
